 ...
 */
async function fetchModelsWithRetry(url, headers, maxRetries = 3, provider, startTime, budgetMs) {
...
async function listModels(provider, baseUrl, apiKey) {
    ...
    let url = provider === 'openrouter'
        ...
        : (0, endpoints_1.getModelsEndpointForBase)(base);
    ...
    try {
        ...
        if (err && typeof err === 'object') {
            ;
            err.modelsEndpointUrl = url;
            err.attemptedUrl = err.attemptedUrl || url;
