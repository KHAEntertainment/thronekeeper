...
exports.applyAnthropicUrl = applyAnthropicUrl;
 ...
 */
async function applyAnthropicUrl(options) {
    ...
    const env = { ANTHROPIC_BASE_URL: url };
    ...
    const apiTimeoutMs = cfg.get('claudeCode.apiTimeoutMs', 3000000);
    ...
    const envForTerminal = Object.fromEntries(Object.entries(env).filter(([_, v]) => v !== null).map(([k, v]) => [k, String(v)]));
...
//# sourceMappingURL=AnthropicApply.js.map