...
⏺ Based on the README, here's a 1-paragraph
  ...
  [[Home.md|Thronekeeper]] (formerly Claude-Throne) is
...
⏺ Based on the README and documentation,
  ...
  diverged in [[guides/ARCHITECTURE.md|architecture]] and scope while
  ...
  [[guides/cli.md|CLI]]-focused proxy, Claude-Throne features
