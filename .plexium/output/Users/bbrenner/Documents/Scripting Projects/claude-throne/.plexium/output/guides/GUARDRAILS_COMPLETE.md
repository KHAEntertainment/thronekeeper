...
|----------|---------|--------|
| `CONSTITUTION.md` | [[guides/ARCHITECTURE.md|Architecture]] invariants | ✅ Complete |
...
✅ **Clear documentation** (CONSTITUTION, [[guides/IMPLEMENTATION_PLAN.md|implementation plan]], handoff docs)  
