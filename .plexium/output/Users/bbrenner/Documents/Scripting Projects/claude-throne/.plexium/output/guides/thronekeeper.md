---
title: "Thronekeeper - Universal AI Model Routing for VS Code"
ownership: managed
...
**Seamlessly use any AI model provider with Claude Code and other Anthropic-compatible [[guides/cli.md|cli]]ents.**

[[Home.md|Thronekeeper]] is a powerful VS Code extension that acts as an intelligent proxy, allowing you to use OpenRouter, OpenAI, Together AI, Groq, or any OpenAI-compatible endpoint with tools that expect the Anthropic API format.
