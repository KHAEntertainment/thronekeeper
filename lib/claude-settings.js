...
export async function updateClaudeSettings(
  ...
  console.log(`[ClaudeSettings] Environment variables: ${JSON.stringify(newEnv)}`)
    ...
    try {
      ...
      try {
        ...
        if (content.trim()) {
          ...
          console.log(`[ClaudeSettings] File ${fileName} is empty, will create new`)
        }
      } catch (err) {
        if (err.code === 'ENOENT') {
          console.log(`[ClaudeSettings] File ${fileName} does not exist, will create new`)
        } else if (err instanceof SyntaxError) {
          console.log(`[ClaudeSettings] File ${fileName} has invalid JSON, will create new`)
        } else {
