...
**Universal AI Model Routing for Claude Code** — Use any AI provider (OpenRouter, OpenAI, Together, Deepseek, GLM) with Claude Code and Anthropic-compatible [[guides/cli.md|cli]]ents.
...
Thronekeeper evolved from [anthropic-proxy](https://github.com/maxnowack/anthropic-proxy) by Max Nowack. While the [[guides/ARCHITECTURE.md|architecture]] has been rebuilt, we’re grateful for the inspiration.
